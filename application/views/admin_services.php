...
<div class="content">
    ...
    <?php
        if ($services != "") {
            ...
            echo "<div class='service-group-number'>1</div>";
            echo "<form class='service-group-title form-update-group-name' data-content-type='text' data-anim='fade-anim' method='post' action='" . base_url("admin/update_service_group_name") . "' ><span class='label'>Nama Group : </span><input type='hidden' name='service_group_id' value='" . $services[0]->service_group_id . "' /><input type='text' name='service_group_name' value='" . $services[0]->service_group_name . "' /></form>";
            echo "<form class='form-delete' method='post' action='" . base_url("admin/delete_group") . "'><input type='hidden' name='service_group_id' value='" . $services[0]->service_group_id . "' /><button class='btn btn-delete btn-delete-group'>Hapus Group</button></form>";
            ...
            echo "<form class='form-delete' method='post' action='" . base_url("admin/delete_package") . "'><input type='hidden' name='service_package_id' value='" . $services[0]->service_package_id . "' /><input type='hidden' name='service_group_id' value='" . $services[0]->service_group_id . "' /><button class='btn btn-delete btn-delete-package'>Hapus Paket</button></form>";
            ...
            for ($i = 1; $i < $iLength; $i++) {
                if ($serviceGroupId != $services[$i]->service_group_id) {                    
                    ...
                    echo "<div class='service-group-number'>" . $serviceGroupCtr . "</div>";
                    echo "<form method='post' action='" . base_url("admin/update_service_group_name") . "' class='service-group-title form-update-group-name' data-content-type='text' data-anim='fade-anim' ><span class='label'>Nama Group : </span><input type='hidden' name='service_group_id' value='" . $services[$i]->service_group_id . "' /><input type='text' name='service_group_name' value='" . $services[$i]->service_group_name . "' /></form>";
                    echo "<form class='form-delete' method='post' action='" . base_url("admin/delete_group") . "'><input type='hidden' name='service_group_id' value='" . $services[$i]->service_group_id . "' /><button class='btn btn-delete btn-delete-group'>Hapus Group</button></form>";
                ...
                echo "<form class='form-delete' method='post' action='" . base_url("admin/delete_package") . "'><input type='hidden' name='service_package_id' value='" . $services[$i]->service_package_id . "' /><input type='hidden' name='service_group_id' value='" . $services[$i]->service_group_id . "' /><button class='btn btn-delete btn-delete-package'>Hapus Paket</button></form>";
