...
<a href="<?php echo base_url("admin/archived"); ?>" class="header-menu-left active" >archived works</a>
...
<div class="content">
<div class="content-title">Archived Works</div>
<?php for ($i = 0; $i < sizeof($works); $i++) { ?>
    <form class="edit-item" method="post" action="<?php echo base_url("admin/archived_works_update"); ?>" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?php echo $works[$i]->archived_works_id; ?>" />
    ...
    <form class="form-delete" method="post" action="<?php echo base_url("admin/archived_works_delete"); ?>">
        <input type="hidden" name="id" value="<?php echo $works[$i]->archived_works_id; ?>" />
...
<form class="dialog hidden" method="post" action="<?php echo base_url("admin/archived_works_insert"); ?>" enctype="multipart/form-data">
