<div class="content">
    ...
    <div class="section section-2">
        <div class="service-group">
            <div class="service-group-title" data-content-type="text">PREWEDDING</div>
            <div class="service-area" data-content-type="text">(SURABAYA AREA)</div>
            <div class="service-package service-package-left">
            ...
            <div class="service-package service-package-right">
        ...
        <div class="service-group">
            <div class="service-group-title" data-content-type="text">PRESWEET</div>
            <div class="service-area" data-content-type="text">(SURABAYA AREA)</div>
            <div class="service-package service-package-left">
                <div class="service-package-title" data-content-type="text">BASIC</div>
        ...
        <div class="service-group">
            <div class="service-group-title" data-content-type="text">WEDDING JOURNALISM</div>
            <div class="service-area" data-content-type="text">(SURABAYA AREA)</div>
            <div class="service-package service-package-left">
